...
http {
    ...
    server {
       ...
       ${comment1}root                                 /var/www/${sitedir};
       ${comment1}index                                ${index};
        ...
        # auth_basic
       ${comment2}location / {
           ${comment2}root /var/www/html;
           ${comment2}index index.html index.htm;
           ${comment2}auth_basic "Login Required";
           ${comment2}auth_basic_user_file /etc/nginx/.htpasswd;
       ${comment2}}
